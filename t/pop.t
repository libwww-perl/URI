...
$u->auth("+APOP");
ok($u->auth eq "+APOP" && $u eq 'pop://aas;AUTH=+APOP@pop.sn.no');

$u->user("gisle");
ok($u->user eq "gisle" && $u eq 'pop://gisle;AUTH=+APOP@pop.sn.no');
...
$u->user('får;k@l');
ok($u->user eq 'får;k@l' && $u eq 'pop://f%E5r%3Bk%40l@pop.sn.no');
